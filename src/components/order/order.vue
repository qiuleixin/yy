<template>
    <div>
       ...
       <el-card>
           ...
           <el-table :data="orderlist" border stripe>
                ...
                <el-table-column label="下单时间" prop="update_time">
                    <template slot-scope="scope">
                        {{scope.row.update_time | datFormat}}
                    </template>
                </el-table-column>
                <el-table-column label="操作">
                    <el-button size="mini" type="primary" icon="el-icon-edit" @click="editOeder"></el-button>
       ...
       <el-dialog
        ...
        <!-- 展示物流进度对话框 -->
        <el-dialog title="物流进度" :visible.sync="showDialogVisible"
        width="50%">
            <el-timeline>
                <el-timeline-item
                v-for="(activity, index) in showProgressData"
                :key="index"
    ...
    created() {
     ...
     methods:{
        ...
        async showProgressBox() {
            ...
            console.log(res.data)
            this.showProgressData=res.data
